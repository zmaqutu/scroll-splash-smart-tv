...
export default function Menu({ topics, selectedTopic, setSelectedTopic }: MenuProps) {
	...
	return (
		<div className="w-1/4 h-full bg-red-200 p-4 flex flex-col">
			...
			<div className="flex-1 overflow-y-auto grid grid-cols-1 gap-2 auto-rows-fr">
				{topics.map((topic) => (
					<button 
						...
						className={`bg-gray-300 text-gray-700 p-4 rounded hover:bg-gray-400 transition ${selectedTopic === topic.title ? 'bg-blue-400 text-white' : ''}`}
